    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ParadeContext>(options =>
              options.UseSqlServer("Data Source=\"172.21.6.56\\EMPLOYEEINFO, 64355\";Database=parade;Integrated Security=False;User ID=sa;Password=Zw@ng#r2014;Connect Timeout=15;Encrypt=False;TrustServerCertificate=True;"));
            services.AddMvc();
        }
